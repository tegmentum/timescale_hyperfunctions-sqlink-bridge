# timescale-hyperfunctions-sqlite-bridge-dynlink

Phase A dynlink-mode sqlite bridge for `timescale_hyperfunctions` (target `timescale_hyperfunctions`).
...
provider `timescale_hyperfunctions-composed`. Aggregate / vtab / hook exports are
